 ...
 */
interface Tuning {
    fun Pitch.toFrequency(): Hertz
    fun Hertz.toNearestPitch(): Pitch

    class EqualTemperament(private val frequencyOfAAboveMiddleC: Hertz) : Tuning {
        ...
        override fun Hertz.toNearestPitch() = Pitch((ln(this / frequencyOfAAboveMiddleC) / semitone).roundToInt())
    }
